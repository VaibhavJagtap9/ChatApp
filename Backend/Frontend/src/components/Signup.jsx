      ...
      <div>
        <div className='flex h-screen items-center justify-center'>
          <form
            ...
            {errors.name && <span className='text-red text-sm font-semibold'>**This field is required**</span>}
            ...
            {errors.email && <span className='text-red text-sm font-semibold'>**This field is required**</span>}
            ...
            {errors.password && <span className='text-red text-sm font-semibold'>**This field is required**</span>}
            ...
            <div className='flex justify-center'>
              <input type='submit' value='Sign Up' className='text-white bg-blue-600 w-full rounded-lg py-2 cursor-pointer' />
              {errors.exampleRequired && <span>This field is required</span>}
            </div>

            <p>Have any Account? {" "} <Link to={"/login"} className='text-blue-500 underline cursor-pointer '>Login</Link></p>
